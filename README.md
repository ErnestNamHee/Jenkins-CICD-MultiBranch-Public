...
The following video illustrates how to create a stream on Flexible Engine DIS : [![Create Stream Video in DIS](https://i.imgur.com/vKb2F1B.png)](http://chilp.it/171788b)  
...
[![Create Stream Video in DIS](https://i.imgur.com/vKb2F1B.png)](http://chilp.it/c02416a)  
...
The following video illustrates how to connect to IOT Message Broker and publish message using MQTT protocol as if IOT Device would do so: [![Publish Message](https://i.imgur.com/vKb2F1B.png)](http://chilp.it/7e507e8)  
...
The following video illustrates how to check the traffic on DIS and downloed the data file collected by DIS : [![Check DIS](https://i.imgur.com/vKb2F1B.png)](http://chilp.it/d565563)  
